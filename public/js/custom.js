...
function showLoader(buttonId) {
  $('#' + buttonId).html('<div class="loader"></div>').prop('disabled', true);
}

// Helper function to hide loader and restore button text
function hideLoader(buttonId, text) {
  $('#' + buttonId).html(text).prop('disabled', false);
}
...
// DISABLED - Nomination form now handled in nomination.blade.php
/*
...
// });
*/
// END DISABLED nomination form section
